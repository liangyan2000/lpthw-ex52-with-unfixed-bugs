...
jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr.
...
Do you 'throw the bomb' or 'slowly place the bomb'?
""")
...
try: laser_weapon_armory.add_paths({'520': the_bridge})
except:
    laser_weapon_armory.add_paths({***: generic_death})
